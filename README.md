...
Ask Claude to analyze the current project and write a starter `CLAUDE.md` (build/test commands, code style, conventions). Requires the text editor tool so Claude can write the file.
